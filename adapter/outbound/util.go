...
func serializesSocksAddr(metadata *C.Metadata) []byte {
	...
	//log.Debugln("serializesSocksAddr:%v %v", metadata.AddrType, metadata)
	//dispatchType := socks5.AtypDomainName
	//if metadata.DstIP != nil {
	//	if metadata.DstIP.To4() != nil {
	//		dispatchType = socks5.AtypIPv4
	//	} else {
	//		dispatchType = socks5.AtypIPv6
	//	}
	//}
