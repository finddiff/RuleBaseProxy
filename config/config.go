...
import (
	...
	providerTypes "github.com/finddiff/clashWithCache/constant/provider"
	"github.com/finddiff/clashWithCache/dns"
	"github.com/finddiff/clashWithCache/log"
	R "github.com/finddiff/clashWithCache/rule"
	T "github.com/finddiff/clashWithCache/tunnel"
...
func parseGeneral(cfg *RawConfig) (*General, error) {
	...
	return &General{
		Inbound: Inbound{
			...
			TUNPreUp:    cfg.TUNPreUp,
			TUNPostUp:   cfg.TUNPostUp,
		},
		Controller: Controller{
			ExternalController: cfg.ExternalController,
			ExternalUI:         cfg.ExternalUI,
			Secret:             cfg.Secret,
			ExternalCMD:        cfg.ExternalCMD,
		},
		Mode:      cfg.Mode,
